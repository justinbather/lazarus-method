# Generated by Django 4.1.5 on 2023-03-29 01:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.CharField(choices=[('Wellness Explorer', 'Wellness Explorer'), ('Personalized Pathfinder', 'Personalized Pathfinder'), ('Elite Transformation Journey', 'Elite Transformation Journey')], max_length=28)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completed', models.BooleanField(blank=True, default=False)),
                ('belt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.belt')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam_number', models.IntegerField(choices=[(1, '1'), (2, '2')], verbose_name='Exam Number')),
                ...
                ('nourish_grade', models.IntegerField(blank=True, choices=[(10, '10'), (7, '7'), (5, '5'), (3, '3'), (1, '1')], verbose_name='Nourish Grade')),
